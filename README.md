...
<p><strong>Trustless Escrow Platform for Open Source Maintainers and Contributors on Stellar.</strong></p>
...
**DealVault** is a trustless escrow platform built on [Stellar](https://stellar.org) and [Soroban](https://soroban.stellar.org) smart contracts — designed to connect open source maintainers with contributors through guaranteed, on-chain payments.

Every issue on DealVault has a verified reward locked in escrow **before work begins**. Contributors never work on a promise. Maintainers never pay without receiving work. Smart contracts enforce everything automatically.

### Platform Roles
- **🏗️ Maintainers**: Open source project owners who want to attract contributors by funding their GitHub issues with USDC. Maintainers can choose to be **Self-Funded** (deposit their own USDC) or participate in **Free / Network** visibility.
- **👨‍💻 Contributors**: Developers who want to earn USDC by solving funded issues. All contributors must complete **KYC verification** and connect a supported Stellar wallet (**Freighter, Lobstr, or xBull**).

### Campaigns & Issue Complexity
DealVault supports **Campaigns**, which distribute a pool of USDC across approved repositories over a defined period. Issues are priced by complexity:
- **Trivial ($2)**: Typos, small UI fixes.
- **Medium ($5)**: Bug fixes, small features.
- **High ($8–$10)**: Complex features, major refactors.
...
```
 Maintainer                                   Contributor
        ...
        │     └─────────────────────────────┘           │
        │                                               │
        │  3. Issues shown as ✓ FUNDED  ────────────────│
        │                                               │  4. Completes KYC & Connects Wallet
        │                                               │  5. Applies & gets Assigned
        │                                               │  6. Completes work & Submits PR
        │  7. Reviews & Approves ◄──────────────────────│
        │     ┌─────────────────────────────┐           │
...
Issues on DealVault move through a defined set of states:
